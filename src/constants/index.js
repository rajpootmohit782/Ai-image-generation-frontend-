export const surpriseMePrompts = [
  ...
  'A teapot made of chocolate, with steam rising from the spout, food photography.',
  'A graffiti mural of a hummingbird wearing a top hat and holding a tiny umbrella.',
  'A retro-style poster advertising a robot circus in the year 2050.',
  'A close-up photograph of a dandelion seed floating in mid-air.',
  'A watercolor painting of a mermaid riding a bicycle underwater.',
  'A sculpture made entirely out of recycled materials, depicting a giant octopus.',
  'A comic strip featuring a superhero squirrel saving acorns from evil squirrels.',
  'A digital illustration of a futuristic cityscape with floating islands and flying cars.',
  'A photograph of a desert landscape with a lone cactus standing tall against the setting sun.',
  'A collage of vintage postcards from different countries, forming a world map.',
  'An oil painting of a lion wearing a crown, sitting on a throne in a regal pose.',
  'A hand-drawn mandala with intricate patterns and vibrant colors.',
  'A photograph of a waterfall frozen in time, appearing like a delicate ice sculpture.',
  'A surreal digital artwork of a clock melting into a puddle of rainbow-colored liquid.',
  'A mixed-media artwork combining photography and embroidery, featuring a blossoming flower garden.',
  'A ceramic sculpture of a teapot in the shape of a teacup, defying traditional design.',
  'A black and white photograph of a street musician playing a saxophone in a dimly lit alley.',
  'A digital illustration of a magical forest filled with glowing mushrooms and fireflies.',
  'A painting of a peacock with feathers made of intricate patterns inspired by stained glass.',
  'A paper collage depicting a whimsical underwater scene with fish wearing top hats and bow ties.',
];
